...
function FeaturedCard({ shopName, src, description, location, phone, address, featuredFood, otherInfo }) {
    return (
        <div className="card m-1" style={{ width: '50rem' }}>
            ...
            <ul className="list-group list-group-flush">
                ...
                <li className="list-group-item"><strong>Adress: </strong>{address}</li>
                <li className="list-group-item"><strong>Phone: </strong>{phone}</li>
            </ul>
            <div className="card-body d-flex">
                <a href="https://www.vallartaexpress.com/menu/" className="card-link">Menu</a>
                <a href="https://www.vallartaexpress.com/" className="card-link">View Website</a>
